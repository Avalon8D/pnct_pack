...
parser.add_argument('dest_tag',
                    help="Type of classes used for the destiantion equipments, for example: pnct, sgp, hdm4.")
parser.add_argument('--source-tag', default='pnct',
                    help="Type of classes used for the source equipments, for example: pnct, sgp, hdm4. Defaults to pnct.")
